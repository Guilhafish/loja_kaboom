...
// Buscar produtos da categoria "Tochas"
$sql = "SELECT * FROM produto WHERE categoria = 'Tochas'";
...
<head>
    ...
    <title>Tochas - Kaboom</title>

    <!-- CSS externo -->
    <link rel="stylesheet" href="../CSS/tochas.css">
</head>
<body>
...
<header>
    ...
    <nav class="menu">
        <ul>
            ...
            <li><a href="tochas.php" class="active">Tochas</a></li>
...
<main>
    ...
    <h2 class="titulo-categoria">Tochas</h2>
